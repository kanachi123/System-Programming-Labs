#!/usr/bin/env python3 
#шебанг для указания что этот файл нужно запускать через интерпретатор python3
#когда так пишешь система позволяет запустить неявно без написания python3,
#а как обычный исполняемый файл(хотя это не одно и то же)

""" это типо для логирования """
import logging
